...
const FAQ = ({ visaType }) => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "You will receive a notification from the visa processing center or the embassy once your visa is approved, often followed by an appointment to collect your visa.",
    },
  ];
